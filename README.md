...
````
docker run --device nvidia.com/gpu=all -v "$(pwd)"/files:/app/files wildfire-model python main.py --config project.yaml --dataset small.pt --exp_name test --auto_upload
````
